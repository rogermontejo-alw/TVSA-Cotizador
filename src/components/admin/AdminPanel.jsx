        ...
        <div className="min-h-screen bg-enterprise-50 pb-20 animate-premium-fade">
            ...
            <div className="max-w-[1800px] mx-auto px-0 -mt-24 relative z-20">
                ...
                <div className="mt-24 text-center pb-10">
                    <p className="text-[10px] font-black text-enterprise-300 uppercase tracking-[0.5em] opacity-60">Capa de Administración Televisa MID • Despliegue Empresarial v2.2.3</p>
